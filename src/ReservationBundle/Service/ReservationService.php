...
class ReservationService {
    ...
    public function annuleDate($client, $id) {
        ...
        $this->notifyInValidation($client);
        $this->entityManager->flush();
    }
    ...
    public function notifyInValidation($client) {
        $message = $this->contenuMailInValidation($client);
    ...
    public function notifyValidation($client) {
        $message = $this->contenuMailValidation($client);
    ...
    private function contenuMailValidation($client) {
        return '
		<!DOCTYPE html>
		<html>
		<head>
    ...
    private function contenuMailInValidation($client) {
        return '
		<!DOCTYPE html>
		<html>
		<head>
		...
		<body>
		     ...
		     <p>Une de vos réservations a été annulé ! <br> Veuillez consulter votre calendrier des rendez-vous en cliquant sur le lien suivant : </p> 
		     <a href="https://beezyweb.net/privee/profile/profil">Mes rendez-vous</a> .<br>.
